            ...
            <footer className="footer footer-horizontal footer-center bg-gradient-to-r from-blue-200 via-pink-100 to-yellow-100 dark:bg-gradient-to-r dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-base-content dark:text-gray-200 rounded-xl p-10">
                ...
                <nav>
                    <div className="grid grid-flow-col gap-4">
                        <a title="Twitter" className="rounded-full bg-white dark:bg-gray-800 p-2 shadow hover:bg-blue-100 dark:hover:bg-[#87CEEB20] transition">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                        ...
                        <a title="YouTube" className="rounded-full bg-white dark:bg-gray-800 p-2 shadow hover:bg-red-100 dark:hover:bg-[#8B000020] transition">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                        ...
                        <a title="Facebook" className="rounded-full bg-white dark:bg-gray-800 p-2 shadow hover:bg-blue-200 dark:hover:bg-[#00BFFF20] transition">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
