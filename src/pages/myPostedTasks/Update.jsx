...
const Update = () => {
    ...
    return (
        <div className="max-w-xl mx-auto bg-white dark:bg-gray-900 shadow-lg rounded-2xl p-8 mt-10 border border-pink-100 dark:border-pink-300">
            <h2 className="text-2xl font-bold text-pink-600 dark:text-pink-300 mb-6 text-center">Update Task</h2>
            <form className="space-y-5" onSubmit={handleUpdate}>
                ...
                <div>
                    <label className="block mb-1 font-semibold text-gray-700 dark:text-gray-200">Budget</label>
                    <input
                        type="number"
                        name="budget"
                        defaultValue={budget}
                ...
                <div>
                    <label className="block mb-1 font-semibold text-gray-700 dark:text-gray-200">Deadline</label>
                    <input
                        type="date"
                        name="deadline"
                        defaultValue={
